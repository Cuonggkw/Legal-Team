  ...
  async create (req, res) {
    try {
      ...
      if(_check === false){
        ...
        if (_data?.new_imgae) {
          try {
            const _parse = extractBase64(_data.new_imgae.file); // `image` là key trong form upload
            ...
            await this.uploadFileLocal(_data.new_imgae, filePath);
            _data.new_imgae = filePath;
          } catch (e) {
            console.log(e);
